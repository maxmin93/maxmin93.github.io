...
![HTML5 Outliner - Chrome Extension](https://accessibility.mste.illinois.edu/sites/default/files/inline-images/outliner_demo.png){: width="500"}
...
![HTML5 Element Flowchart](https://i.stack.imgur.com/8Ruyj.png){: width="600px"}
_HTML5 Element Flowchart_

> W3 wiki page about structing HTML5 

![W3 - HTML5 struct](https://i.stack.imgur.com/L4qMt.png){: width="600px"}
