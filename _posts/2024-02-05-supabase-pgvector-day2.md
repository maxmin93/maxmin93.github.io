...
tags: ["supabase", "openai", "embedding", "2nd-day"]
image: "https://dyclassroom.com/image/topic/postgresql/postgresql.jpg"
---

> PostgreSQL(supabase) 에서 한글 검색을 위한 pgvector 사용법을 알아봅니다. 영문 리뷰 데이터를 openai API 로 임베딩하여 유사 문서를 찾는 실습을 진행합니다.
{: .prompt-tip }
...
<img src="/2024/02/05-airbnb-recommend-with-openai.png" alt="airbnb-recommend-with-openai" width="70%" />
