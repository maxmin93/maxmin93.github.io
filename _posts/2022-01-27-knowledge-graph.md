...
![지식은 진실과 신뢰의 교집합인가?](/2022/01/27-pic01.png){: width="540"}
...
![시맨틱 웹 기술 계층 구조](/2022/01/27-pic02.jpeg){: width="540"}
...
![구글 검색결과에 포함되어 사용되는 지식그래프](/2022/01/27-pic03-w640.png){: width="540"}
...
![RDF 그래프 모델의 기본 구조와 그래프 모델 표현 예시](/2022/01/27-pic04.png){: width="540"}
...
![Entity 개체를 연결하여 확장한 그래프 모델](/2022/01/27-pic05.png){: width="540"}
...
![지식그래프와 딥러닝 모델이 통합된 설명 가능한 AI 시스템](/2022/01/27-pic16.png){: width="540"}
...
![IT 공룡들의 지식그래프](/2022/01/27-pic08.jpeg){: width="540"}
_&lt;표&gt; IT 공룡들의 지식그래프_
...
![CLEVR graph 지식그래프에 대해 Cypher 쿼리로 질의응답](/2022/01/27-pic06.png){: width="540"}
...
![Neo4j의 APOC 그래프 알고리즘과 Cypher 쿼리를 이용한 node 수집 예](/2022/01/27-pic10.png){: width="540"}
...
![여러 의존 분석 그래프를 병합하여 하나의 신뢰 그래프를 구성하는 예시](/2022/01/27-pic09.png){: width="540"}
...
![네이버 지식그래프 서비스 예시](/2022/01/27-pic11.png){: width="540"}
...
![엘비스 프레슬리에 관한 위키피디아 자연어 문장으로부터 트리플 집합을 추출하는 예](/2022/01/27-pic12.png){: width="540"}
...
![확장된 지식그래프인 PolarisX를 통해 출력된 답변 그래프 예시](/2022/01/27-pic13.png){: width="540"}
...
![경로형 질문과 접속형 질문의 예](/2022/01/27-pic14.png){: width="540"}
...
![쿼리와 유사한 트리플 술어를 추출해 쿼리를 확장하는 예제](/2022/01/27-pic15.png){: width="540"}
