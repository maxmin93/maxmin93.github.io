...
### VSCode 에 Github Copilot 확장 모듈 설치
...
| ![todos_asc 함수 코드 제안](/2022/09/16-vue3-my-todo-app-crunch.png){: width="580"} |
| :--: |
...
| ![todos_asc 함수 코드 제안 전체](/2022/09/16-vue3-my-todo-app-suggestions-crunch.png){: width="580"} |
| :--: |
...
## 4. 이후에 python 도 시도해 볼 계획임

일단 대강 맛만 본 상태입니다. 무료 이용기간을 포함해 한동안 되든 안되든 켜놓고 써보려 합니다. 
