...
> Visual Studio Code 개발 컨테이너 확장 기능을 사용하는 방법을 공부합니다. Docker 컨테이너 기반 개발 환경은 여러 개발자가 동일한 환경에서 개발할 수 있도록 합니다.
{: .prompt-tip }
...
![dev-container architecture](https://code.visualstudio.com/assets/docs/devcontainers/containers/architecture-containers.png){: width="600"}
