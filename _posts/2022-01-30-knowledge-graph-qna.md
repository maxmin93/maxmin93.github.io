...
![한국어에 특화된 트리플의 시각화 예시](/2022/01/30-pic02.png){: width="540"}<br>
&lt;그림&gt; AgensKG에서 사용된 질의 타입 6종

![AgensKG 질의분석기 API의 JSON 형식](/2022/01/30-pic03.png){: width="540"}<br>
&lt;그림&gt; AgensKG 질의분석기 API의 JSON 형식

![AgensKG 질의분석기 API의 JSON 예시](/2022/01/30-pic04.png){: width="540"}<br>
...
![질문의 서브그래프 예시](/2022/01/30-pic05.png){: width="540"}<br>
...
![단어셋 크기](/2022/01/30-pic07.png){: width="300"}

![간선 가중치](/2022/01/30-pic08.png){: width="260"} 라고 합니다. 두 단어의 유사도인 edge weight는 동일한 Word2Vec 모델을 사용하고 있기 때문에 Q_WORDS 간의 edge weight는 R_WORDS 간의 edge에서도 동일합니다.

![질문 서브그래프에 대한 지식그래프의 그래프 유사도 예시](/2022/01/30-pic06.png){: width="540"}<br>
...
![전체 간선 가중치합 Q](/2022/01/30-pic09.png){: width="340"}

![그래프 밀도 Q](/2022/01/30-pic10.png){: width="340"}

마찬가지로 결과 그래프의 서브그래프에 대해서도 total_sim 과 density를 산출합니다.
단, ![간선 거리](/2022/01/30-pic11.png){: width="260"} 라 하고 단어가 사용된 트리플간의 거리만큼 edge weight를 나누어서 적용합니다. 예를 들어, 단어 '지출'과 '양육비'간의 거리가 질문 서브그래프에서는 distance=0 이지만, 결과 서브그래프에서 distance=1 이면 단어 유사도를 거리차만큼 1/2로 감소시켜 적용합니다. 그리고 결과 서브그래프의 edge_weight는 질문 서브그래프의 교집합 단어셋인 WORDS 안에서 산출하지만, 결과 서브그래프의 node 크기는 R_WORDS 로부터 구합니다.

![전체 간선 가중치합 R](/2022/01/30-pic12.png){: width="340"}

![그래프 밀도 R](/2022/01/30-pic13.png){: width="340"}
...
![그래프 유사도 g_score](/2022/01/30-pic14.png){: width="280"}
...
![Answer 함수의 탐색 전략 및 순위 재정렬 로직](/2022/01/30-pic15.png){: width="540"}<br>
...
![AgensKG 질의응답 API 결과 예시](/2022/01/30-pic18.png){: width="540"}<br>
&lt;그림&gt; AgensKG 질의응답 API 결과 예시

![AgensKG 질의응답 결과의 시각화](/2022/01/30-pic19.png){: width="540"}<br>
