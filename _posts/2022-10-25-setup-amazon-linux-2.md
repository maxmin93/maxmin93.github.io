...
title: AWS Lightsail 에서 Amazon Linux 2 초기 설정하기
categories: ["devops","aws"]
tags: ["lightsail", "linux", "setup", "install"]
image: "https://roi4cio.com/fileadmin/user_upload/Amazon_Lightsail.png"
---

> AWS Lightsail 에서 Amazon Linux 2 를 선택하고 초기 설정 작업을 기록합니다.
{: .prompt-tip }
...
- 서버를 껏다 켰다 할 수 있다. (종량제)
  + 관리를 통해 요금을 절감할 수 있다. (노력에도 한계가 있다)
