...
image:
  src: https://posts/effectivepython.com/images/cover_2ed.jpg
---
...
* 01) 사용중인 파이썬의 버전을 알아두라 [&#9658;link](/posts/posts/effective-py-2nd-ch01#item01)
* 02) PEP 8 스타일 가이드를 따르라 [&#9658;link](/posts/effective-py-2nd-ch01#item02)
* 03) 3 bytes와 str의 차이를 알아두라 [&#9658;link](/posts/effective-py-2nd-ch01#item03)
* 04) C 스타일 형식 문자열을 str.format로 쓰기보다는 f-문자열을 통한 인터폴레이션을 사용하라 [&#9658;link](/posts/effective-py-2nd-ch01#item04)
* 05) 복잡한 식을 쓰는 대신 도우미 함수를 작성하라 [&#9658;link](/posts/effective-py-2nd-ch01#item05)
* 06) 인덱스를 사용하는 대신 대입을 사용해 데이터를 언패킹하라 [&#9658;link](/posts/effective-py-2nd-ch01#item06)
* 07) range보다는 enumerate를 사용하라 [&#9658;link](/posts/effective-py-2nd-ch01#item07)
* 08) 여러 이터레이터에 대해 나란히 루프를 수행하려면 zip을 사용하라 [&#9658;link](/posts/effective-py-2nd-ch01#item08)
* 09) for나 while 루프 뒤에 else 블록을 사용하지 말라 [&#9658;link](/posts/effective-py-2nd-ch01#item09)
