...
> Desktop App 을 만들 수 있는, Electron 대체 프레임워크인 Tauri 와 Wails 에 대해 알아보자. 윈도우 10 환경에서 애플리케이션을 빌드해 보자.
{: .prompt-tip }

## 1. Desktop Application 개발 프레임워크

멀티 OS 를 지원하는 크로스 플랫폼이다. 동종 제품으로 Electron, NW.js, Neutralino(C++), Tauri, Wails 등이 있다.

- Flutter 도 크로스 플랫폼이지만, dart 언어만 지원
...
### 3) Tauri vs Wails vs Electron (비교)

- 공통점 : OS 에 내장된 WebView 를 사용하기 때문에 바이너리 크기가 작다

#### NW.js 장단점

- Rust/Go 같은 저수준 언어를 사용할 필요가 없음 (only JS)
- 번들로 제공되는 브라우저를 포함하므로 바이너리 크기가 크다
...
![tauri-demo-app-setup-wizard](/2023/08/13-tauri-demo-app-setup-wizard.png){: width="480"}
...
![tauri-demo-app-dev-run](/2023/08/13-tauri-demo-app-dev-run.png){: width="560"}
...
![tauri-html-app-dev-run](/2023/08/13-tauri-html-app-dev-run.png){: width="560"}
...
![tauri-svltk-static-dev-run](/2023/08/13-tauri-svltk-static-dev-run.png){: width="560"}

> Svelte Demo 앱도 적용해 보았다. (잘된다)

![tauri-svltk-demo-dev-run](/2023/08/13-tauri-svltk-demo-dev-run.png){: width="400"}
...
![wails-demo-app-dev-run](/2023/08/13-wails-demo-app-dev-run-w560.png){: width="560"}
...
![wails-svltk-static-dev-run](/2023/08/13-wails-svltk-static-dev-run-w560.png){: width="560"}
...
윈도우 응용프로그램으로는 문제가 없었지만, iOS 와 Android 지원도 잘 되야 쓸 듯
