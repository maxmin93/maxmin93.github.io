...
categories: ["graphdb", "neo4j"]
tags: ["jdbc", "etl", "import", "graph-schema", "sql", "mapping"]
---
...
![31_08-neo4j-etl-step4_batch](/2022/03/31_08-neo4j-etl-step4_batch.png){: width="540"}

## Neo4j Browser

임포트 된 데이터 확인

![31_09-neo4j-browser-northwind](/2022/03/31_09-neo4j-browser-northwind.png){: width="540"}
