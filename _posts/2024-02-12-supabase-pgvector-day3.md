...
image: "https://i.ytimg.com/vi/ySus5ZS0b94/sddefault.jpg"
---

> 앞에서 pgvector 사용법을 알아보았고, 이어서 영문 데이터와 한글 데이터를 openai embedding 하는 방법을 진행합니다.
{: .prompt-tip }

- [supabase pgvector - 1일차](/posts/2024-02-01-supabase-pgvector-day1/) : supabase 와 pgvector
- [supabase pgvector - 2일차](/posts/2024-02-05-supabase-pgvector-day2/) : openai embedding
- [supabase pgvector - 3일차](/posts/2024-02-12-supabase-pgvector-day3/) : 한글 embedding
...
[이전 포스트](/posts/2024-02-05-supabase-pgvector-day2/)의 숙박정보 embedding 데이터를 갱신하여 적용한다.
...
<img src="/2024/02/12-airbnb-similarity-ada02-top10.png" alt="airbnb-similarity-embedding-ada-002-top10" width="80%" />
...
<img src="/2024/02/12-airbnb-similarity-3small-top10.png" alt="airbnb-similarity-embedding3-small-top10" width="80%" />
...
<img src="/2024/02/12-airbnb-similarity-3small-desc-top10.png" alt="airbnb-similarity-embedding3-small-only-desc-top10" width="80%" />
...
<img src="/2024/02/12-ko-query3-similarity-by-emb3.png" alt="ko-query3-similarity-by-embedding-3-large" width="90%" />

> text-embedding-ada-002

<img src="/2024/02/12-ko-query3-similarity-by-ada2.png" alt="ko-query3-similarity-by-embedding-ada-002" width="90%" />

#### 쿼리2 : '금전 지원 사업'

> text-embedding-3-large

<img src="/2024/02/12-ko-query2-similarity-by-emb3.png" alt="ko-query2-similarity-by-embedding-3-large" width="90%" />

> text-embedding-ada-002

<img src="/2024/02/12-ko-query2-similarity-by-ada2.png" alt="ko-query2-similarity-by-embedding-ada-002" width="90%" />

#### 쿼리3 : '서귀포 교통 사고'

> text-embedding-3-large

<img src="/2024/02/12-ko-query1-similarity-by-emb3.png" alt="ko-query1-similarity-by-embedding-3-large" width="90%" />

> text-embedding-ada-002

<img src="/2024/02/12-ko-query1-similarity-by-ada2.png" alt="ko-query1-similarity-by-embedding-ada-002" width="90%" />
