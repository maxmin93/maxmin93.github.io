...
> IFTTT 의 개념과 자동화 서비스 형태, 그리고 유사한 SaaS 서비스에 대해 알아보자.
{: .prompt-tip }
...
출처: (https://www.itworld.co.kr/news/135646#csidxe79b59ea8c8a2dcbad011d5499d1c59)
...
시간적 순서로 취합하는게 아니라, 수평적 절단면으로 정보를 수집

- 대상자 중심 : 베스트 상품, 인기 키워드, 추천 여행지 Top 10
- 아이템 중심 : 핫플레이스, 금주의 추천
- 군집 품질 중심 : 연인들을 위한 데이트 코스, 가족식사 추천

## 5. 참고사항

### 1) 양면시장 구조를 위한 플랫폼의 6가지 전략 요소
