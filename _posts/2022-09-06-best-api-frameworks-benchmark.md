...
## [Best API Frameworks For Fast Performance](https://www.snapt.net/blog/best-api-frameworks-for-fast-performance)

### 1위 [Express.js + Node.js](https://github.com/expressjs/express) - 별 58.2k
...
### 2위 [FastAPI](https://github.com/tiangolo/fastapi) - 별 49k
...
### 3위 [Fastify](https://github.com/fastify/fastify) - 별 24.8k
...
### [Fiber](https://github.com/gofiber/fiber) - 별 22.2k
...
### [Phoenix + Elixir](https://github.com/phoenixframework/phoenix) - 별 18.5k
...
## 벤치마크 : [FastAPI vs. Fastify vs. Spring Boot vs. Gin Benchmark](https://www.travisluong.com/fastapi-vs-fastify-vs-spring-boot-vs-gin-benchmark/) (01.10.2022)
...
### [Gin Web Framework](https://github.com/gin-gonic/gin) - 별 62.6k 개
