...
- 이전 포스트 [Zig Tutorial 8th - WASM 빌드 및 WASI](/posts/2025-01-19-zig-tutorial-8th/#wasm-%EB%B9%8C%EB%93%9C) 에서 피보나치 함수를 wasm 으로 빌드하고 wasmtime 에서 실행하는 예제를 다루었다.
