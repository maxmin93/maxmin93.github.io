...
categories: ["AI","gpt"]
tags: ["chatgpt","postgresql","plugin","supabase"]
...
> ChatGPT 플러그인에 Supabase 와 Postgresql 을 사용할 수 있다고 합니다. 관련 문서를 공부합니다. (작성중!!)
{: .prompt-tip }
...
![chatgpt-plugins-support-postgres](https://supabase.com/images/blog/2023-05-25-chatgpt-plugins-support-postgres/chatgpt-plugin-scheme--dark.png){: width="600"}
