...
categories: ["backend","graphql"]
tags: ["pg15", "hasura", "docker", "postgres"]
...
![hasura graphql-engine](https://shahidh.in/graphql-engine/assets/demo.gif){: width="600px"}
...
![hasura headers](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/jwt-decoded.png){: width="560px"}
_hasura headers_
